 ...
 */
@Service
public class TeachplanService extends CommonTreeService<TeachplanNode, Teachplan> implements Comparator<TeachplanNode> {
...
//       对计算的层级进行判断，最多为3层，超出报错。
     ...
     * @param couseid：课程Id
     * @return ResponseResult
     * @Description: 根据courseid确定课程计划是否存在。
    ...
    private String getTeachPlanRootIdByCourseId(String couseid){
        ...
        CourseBase courseBase=courseBaseMappe.findCourseBaseById(couseid);
